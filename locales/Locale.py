...
class Locale(object):
    ...
    def __init__(self, language):
        ...
        #            form_id, form_name) 
        for form_id, form_name in default["forms"].iteritems():
            self.__form_names[int(form_id)] = all_forms.get(form_id, form_name)
        ...
        for form_id, form_name in default["forms"].iteritems():
            self.__english_form_names[int(form_id)] = english_forms.get(form_id, form_name)
